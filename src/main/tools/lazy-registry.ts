...
const toolToModule: Record<string, string> = {
  // WebIntelligence
  web_search: 'web_intelligence',
  web_fetch: 'web_intelligence',
  web_cache: 'web_intelligence',
  web_research: 'web_intelligence',
  // UIGenerate
  ui_generate: 'ui_generate',
  // CodeQuality
  code_execute: 'code_quality',
  code_lint: 'code_quality',
  code_format: 'code_quality',
  dependency_check: 'code_quality',
  project_context: 'code_quality',
  project_index: 'code_quality',
  // FileSystem
  ...
  file_delete: 'file_system',
  multi_edit: 'file_system',
  move_file: 'file_system',
  todo_write: 'file_system',
  // Terminal
  ...
  browser_network_monitor: 'browser',
  // Design
  ...
  find_roots: 'computer_use',
  observe_ui: 'computer_use',
  search_ui: 'computer_use',
  act_ui: 'computer_use',
  read_text: 'computer_use',
  wait_for: 'computer_use',
  // Network
  network_capture: 'network',
  network_replay: 'network',
  storage_inspect: 'network',
  js_hook: 'network',
  api_extract: 'network',
  // Skill
  skill_record: 'skill',
